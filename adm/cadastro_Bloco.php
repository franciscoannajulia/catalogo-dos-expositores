...
<body>
    ...
    <section class="services">
        <div class="container">
            <div class="title text-center">
                <h1 class="title-blue">Cadastro Bloco</h1>
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-6">
      <label for="inputPassword4">Evento:</label>
      <select id="inputState" class="form-control">
        <option selected>Selecione...</option>
        <option>...</option>
      </select>    </div>
  ...
  <div class="form-row">
    <div class="form-group col-md-6">
      <label for="inputEmail4">Tipos de Produto:</label>
      <input type="text" class="form-control" id="inputEmail4"  placeholder="">
    </div>
    <div class="form-group col-md-6">
      <label for="inputPassword4">Product Types:</label>
      <input type="email" class="form-control" id="inputPassword4"  placeholder="">
    </div>
  </div>
