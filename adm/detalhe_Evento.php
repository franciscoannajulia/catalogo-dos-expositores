...
<body>
	...
	<div class="page-info-section set-bg">
		<div class="ccontainer">
            ...
            <a href="index.php">Início</a>
				<a href="ver_Evento.php">Eventos e Feiras</a>
    ...
    <section class="services">
        <div class="container">
            <div class="title text-center">
                <h1 class="title-blue">NOME EVENTO</h1>
                <p>Setor/Área: xxx.<br/>
               Estado: xxx. Cidade: xxx<br/>
               <a class="botao botao-danger" href="alterar_Evento.php" role="button">Alterar Evento</a><br/></p>

                <a class="botao botao-info" href="cadastro_Bloco.php" role="button">Cadastrar Blocos</a>
                <a class="botao botao-info" href="cadastro_Expositor.php" role="button">Cadastrar Expositores</a>
            </div>
            <div class="container">
                <h2>Blocos </h2>
            <table class="table">
  <thead>
    <tr>
      ...
      <th scope="col">Qtde de Expositores</th>      
      <th scope="col">Tipos Produtos</th>
  ...
  <tbody>
    <tr>
      ...
      <td>Bloco Um</td>
      <td>13</td>
      <td>Café, Máquinas de Cáfe</td>
      <td><a class="botao botao-success" href="detalhe_bloco.php" role="button">Visualizar</a>
      <a class="botao botao-info" href="alterar_bloco.php" role="button">Editar</a>
      <a class="botao botao-danger" href="" role="button">Apagar</a>
</td>
    </tr>
  </tbody>
</table>
