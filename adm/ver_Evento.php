    ...
    <section class="services">
        <div class="container">
            <div class="title text-center">
                <h1 class="title-blue">Eventos e Feiras</h1>
            </div>
            <div class="container">
            <table class="table">
  <thead>
    <tr>
      ...
      <th scope="col" >Visualizar/Editar/Apagar</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      ...
      <td>São Paulo</td>
      <td>Café</td>
      <td ><a class="botao botao-success" href="detalhe_Evento.php" role="button">Visualizar</a>
      <a class="botao botao-info" href="" role="button">Editar</a>
      <a class="botao botao-danger" href="" role="button">Apagar</a></td>
