	...
	<div class="page-info-section set-bg">
		<div class="ccontainer">
            ...
            <a href="index.php">Início</a>
                ...
                <a href="detalhe_Bloco.php">Bloco</a>
    ...
    <section class="services">
        <div class="container">
            <div class="title text-center">
                <h2 class="title-blue">NOME DO EXPOSITOR</h2>
            </div> 
           
        </div>
        <div class="container">
        <p>Evento: xxx.<br/></p>
                <p>Setor/Área: xxx.<br/></p>
                <p>Bloco: xxx.<br/></p>
                <p>Estande: xxx.<br/></p>
                <p>Tipos de Produtos: xxx.<br/></p>
                <p>Produtos: xxx.<br/></p>
                <div class="title text-center">
                <a class="botao botao-info" href="alterar_Expositor.php" role="button">Alterar</a>
