...
<body>
	...
	<div class="page-info-section set-bg">
		<div class="ccontainer">
            ...
            <a href="index.php">Início</a>
                <a href="ver_Evento">Eventos e Feiras</a>
                <a href="detalhe_Evento.php">Nome Evento</a>
    ...
    <section class="services">
        <div class="container">
            <div class="title text-center">
                <h2 class="title-blue">NOME DO BLOCO</h2>
                <p>Setor/Área: xxx.<br/>
               <a class="botao botao-danger" href="alterar_bloco.php" role="button">Alterar Bloco</a><br/></p>
  ...
  <tbody>
    <tr>
      ...
      <td>Café</td>
      <td>Café</td>
      <td><a class="botao botao-success" href="detalhe_Expositor.php" role="button">Visualizar</a>
      <a class="botao botao-info" href="alterar_Expositor.php" role="button">Editar</a>
