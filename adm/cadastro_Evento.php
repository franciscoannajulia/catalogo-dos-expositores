...
<body>
    ...
    <section class="services">
        <div class="container">
            <div class="title text-center">
                <h1 class="title-blue">Cadastro do Evento</h1>
                <a style="center" href="ver_Evento.php" class="btn btn-purple" style="">Ver Eventos</a>
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-6">
      <label for="inputPassword4">Event Sector / Area:</label>
      <input type="email" class="form-control" id="inputPassword4"  placeholder="">
    </div>
  </div>
