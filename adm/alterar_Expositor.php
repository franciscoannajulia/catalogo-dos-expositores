...
<body>
    ...
    <section class="services">
        <div class="container">
            <div class="title text-center">
                <h1 class="title-blue">Alterar Expositor</h1>
            </div>
            <div class="container">
                        <form>
  ...
  <div class="form-row">
    ...
    <img src="http://www.calendariodoagronegocio.com.br/view/img/icons/portugues.png" alt="" /><br/>
      <label for="inputEmail4">Nome do Expositor:</label>
      <input type="text" class="form-control" id="inputEmail4" placeholder="">
    </div>
    <div class="form-group col-md-6">
    <img src="http://www.calendariodoagronegocio.com.br/view/img/icons/english.png" alt="" /><br/>
      <label for="inputPassword4">Exhibitor Name:</label>
      <input type="email" class="form-control" id="inputPassword4"  placeholder="">
    </div>
  </div>
  <div class="form-row">
    <div class="form-group col-md-6">
      <label for="inputEmail4">Feira/Evento:</label>
    ...
    <div class="form-group col-md-6">
      <label for="inputPassword4">Fair/Event:</label>
      <select id="inputState" class="form-control">
        <option selected>Selecione...</option>
        <option>...</option>
      </select>
  ...
  <div class="form-row">
    <div class="form-group col-md-6">
      <label for="inputEmail4">Bloco do Expositor:</label>
      <select id="inputState" class="form-control">
        <option selected>Selecione...</option>
        <option>...</option>
      </select>    </div>
    <div class="form-group col-md-6">
      <label for="inputPassword4">Exhibitor Block:</label>
      <select id="inputState" class="form-control">
        <option selected>Selecione...</option>
        <option>...</option>
      </select>    </div>
  ...
  <div class="form-row">
    <div class="form-group col-md-6">
      <label for="inputEmail4">Estande do Expositor:</label>
      <input type="text" class="form-control" id="inputEmail4"  placeholder="">

    </div>
    <div class="form-group col-md-6">
      <label for="inputPassword4">Exhibitor Booth:</label>
      <input type="text" class="form-control" id="inputEmail4"  placeholder="">
  ...
  <div class="form-row">
    <div class="form-group col-md-6">
      <label for="inputEmail4">Tipo de Produto:</label>
      <input type="text" class="form-control" id="inputEmail4"  placeholder="">
    </div>
    <div class="form-group col-md-6">
