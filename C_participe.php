...
<body>
    ...
    <section class="services">
        <div class="container">
            <div class="title text-center">
                <h1 class="title-blue">Participe</h1>
            </div>
            <div class="container">
                        <p>Para ter sua <strong>feira</strong> ou <strong>evento</strong> no Catálogo dos Expositores, é necessário que preencha o formulário e aguardar o contato da nossa equipe.</p>
                        <form>
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-4">
      ...
      <select id="inputState" class="form-control">
        <option selected>Selecione...</option>
        <option value="Anunciar">Quero Participar do Catálogo</option>
